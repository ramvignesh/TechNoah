...
query_str = "select *, ABS(%s - %s) as diff from supply_details where status = 0 and %s != 0 order by diff LIMIT 1"
outgoing_msg_template = "Contact %s for %s. "
fields = ['food','water']
update_need_query = "update need_details set %s = %s where id = %s"
update_supply_query = "update supply_details set %s = %s where id = %s"
